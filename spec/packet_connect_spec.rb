...
describe MqttRails::Packet::Connect do
  context "Connect packet class" do
    it "Create correct connect packet for version 3.1.1" do
      packet = MqttRails::Packet::Connect.new(version: '3.1.1')
    ...
    it "Create correct connect packet for version 3.1.0" do
      packet = MqttRails::Packet::Connect.new(version: '3.1.0')
    ...
    it "Create connect packet with invalid version 2.0" do
      expect { MqttRails::Packet::Connect.new(version: '2.0') }.to raise_error(MqttRails::PacketFormatException, "Unsupported protocol version: 2.0")
    end
  end

  context "Connect packet full field" do
      packet = MqttRails::Packet::Connect.new(
        client_id: '0001',
        version: '3.1.1',
        clean_session: true,
        keep_alive: 30,
